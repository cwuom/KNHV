...
static constexpr const char* kDriverContractTag =
    "PT-HIDDEN-XSTATE-V42-VMWRITE-ORDER-FIRSTEXIT-CANARY-TRIPLEFAULT-FAILSTOP-VMEXIT-NO-DBGPRINT-TARGETED-DEADLINE-CRASH-FIRST-CETU-PASSTHRU-DUMP-LAUNCH-FLIGHTREC-XSS-PRESERVE-FRED-SUBLEAF1-CET-HIDDEN-HYPERDBG-FULL-FRAME-STAGED-COORDINATOR-NATIVE-HOSTSTACK-LASTBYTE-KD-COMPACT-VMWRITE-FIELD-VALUE-RAW-VALUE-FIELD-CR4-SHADOW-IF-HANDOFF-PT-VMXMISC-DPC-RETURN-CR3-GUESTCR4-CET-WP-FIRSTEXIT-CPUID-PROBE-IDT-VECTORING-FAILSTOP-CR3-FLIGHTREC-VMCS-FAILURE-RECORD-CANONICAL-RSP-KGS-PASSTHRU";
